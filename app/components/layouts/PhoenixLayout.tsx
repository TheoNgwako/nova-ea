...
export default function PhoenixLayout({
  ...
  return (
    <>
      ...
      <p className="text-center text-xs tracking-widest text-white/60 mt-4">
        Your Trading With
      </p>
      <h1
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {mentorImage ? (
              ...
              <div className="w-full h-full bg-black flex items-center justify-center text-sm font-bold" style={{ color: accentColor }}>
                AI
              </div>
            )}
          </div>
